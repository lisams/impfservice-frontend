...
export class UserDetailComponent implements OnInit {
  ...
  popupHeadline: string = 'Impfstatus wirklich ändern?';
  popupText: string;
  popupButton: string = 'Bestätigen';
  ...
  ngOnInit(): void {
    ...
    this.us.getUserBySVNR(params.svnr)
      .subscribe((u) => {
        this.user = u;
        this.popupText = `Hiermit bestätigen Sie, dass sich der Impfstatus von ${this.user.firstname} ${this.user.lastname} geändert hat. Sind Sie sicher?`;
